...
processes =    {
    ...
    ('WJetsToLNu_Wpt-0To50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8',2016):('WJets_pt0to50','MC', 62470)
    ('WJetsToLNu_Wpt-50To100_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8',2016):('WJets_pt50to100','MC', 62470)

    # LO Z->nunu
    #2018
    ('ZJetsToNuNu_HT-100To200_13TeV-madgraph',2018):('ZtoNuNu_ht100to200','MC',303.4),
    ('ZJetsToNuNu_HT-200To400_13TeV-madgraph',2018):('ZtoNuNu_ht200to400','MC',91.71),
    ('ZJetsToNuNu_HT-400To600_13TeV-madgraph',2018):('ZtoNuNu_ht400to600','MC',13.10),
    ('ZJetsToNuNu_HT-600To800_13TeV-madgraph',2018):('ZtoNuNu_ht600to800','MC',3.248),
    ('ZJetsToNuNu_HT-800To1200_13TeV-madgraph',2018):('ZtoNuNu_ht800to1200','MC',1.496),
    ('ZJetsToNuNu_HT-1200To2500_13TeV-madgraph',2018):('ZtoNuNu_ht1200to2500','MC',0.3425),
    ('ZJetsToNuNu_HT-2500ToInf_13TeV-madgraph',2018):('ZtoNuNu_ht2500toinf','MC',0.005268),
    #2017
    ('ZJetsToNuNu_HT-100To200_13TeV-madgraph',2017):('ZtoNuNu_ht100to200','MC',304.5),
    ('ZJetsToNuNu_HT-200To400_13TeV-madgraph',2017):('ZtoNuNu_ht200to400','MC',91.85),
    ('ZJetsToNuNu_HT-400To600_13TeV-madgraph',2017):('ZtoNuNu_ht400to600','MC',13.11),
    ('ZJetsToNuNu_HT-600To800_13TeV-madgraph',2017):('ZtoNuNu_ht600to800','MC',3.256),
    ...
    ('WJetsToLNu_HT-200To400_TuneCP5_13TeV-madgraphMLM-pythia8',2018):('WJets_ht200to400_CP5','MC',410.3),
    #'WJetsToLNu_HT-200To400_TuneCP5_13TeV-madgraphMLM-pythia8':('WJets_ht200to400_CP5','MC',359.7),
    ('WJetsToLNu_HT-400To600_TuneCP5_13TeV-madgraphMLM-pythia8',2018):('WJets_ht400to600_CP5','MC',57.85),
    #'WJetsToLNu_HT-400To600_TuneCP5_13TeV-madgraphMLM-pythia8':('WJets_ht400to600_CP5','MC',48.91),
    ('WJetsToLNu_HT-600To800_TuneCP5_13TeV-madgraphMLM-pythia8',2018):('WJets_ht600to800_CP5','MC',12.95),
    #'WJetsToLNu_HT-600To800_TuneCP5_13TeV-madgraphMLM-pythia8':('WJets_ht600to800_CP5','MC',12.05),
    ('WJetsToLNu_HT-800To1200_TuneCP5_13TeV-madgraphMLM-pythia8',2018):('WJets_ht800to1200_CP5','MC',5.451),
    #'WJetsToLNu_HT-800To1200_TuneCP5_13TeV-madgraphMLM-pythia8':('WJets_ht800to1200_CP5','MC',5.501),
    ('WJetsToLNu_HT-1200To2500_TuneCP5_13TeV-madgraphMLM-pythia8',2018):('WJets_ht1200to2500_CP5','MC',1.084),
    #'WJetsToLNu_HT-1200To2500_TuneCP5_13TeV-madgraphMLM-pythia8':('WJets_ht1200to2500_CP5','MC',1.329),
    ('WJetsToLNu_HT-2500ToInf_TuneCP5_13TeV-madgraphMLM-pythia8',2018):('WJets_ht2500toinf_CP5','MC',0.008061),
    #'WJetsToLNu_HT-2500ToInf_TuneCP5_13TeV-madgraphMLM-pythia8':('WJets_ht2500toinf_CP5','MC',0.03216),
    #2017
    ('WJetsToLNu_HT-100To200_TuneCP5_13TeV-madgraphMLM-pythia8',2017):('WJets_ht100to200_CP5','MC',1395),
    #'WJetsToLNu_HT-100To200_TuneCP5_13TeV-madgraphMLM-pythia8':('WJets_ht100to200_CP5','MC',1345),
    ('WJetsToLNu_HT-200To400_TuneCP5_13TeV-madgraphMLM-pythia8',2017):('WJets_ht200to400_CP5','MC',409.3),
    #'WJetsToLNu_HT-200To400_TuneCP5_13TeV-madgraphMLM-pythia8':('WJets_ht200to400_CP5','MC',359.7),
    ('WJetsToLNu_HT-400To600_TuneCP5_13TeV-madgraphMLM-pythia8',2017):('WJets_ht400to600_CP5','MC',57.91),
    #'WJetsToLNu_HT-400To600_TuneCP5_13TeV-madgraphMLM-pythia8':('WJets_ht400to600_CP5','MC',48.91),
    ('WJetsToLNu_HT-600To800_TuneCP5_13TeV-madgraphMLM-pythia8',2017):('WJets_ht600to800_CP5','MC',12.92),
    #'WJetsToLNu_HT-600To800_TuneCP5_13TeV-madgraphMLM-pythia8':('WJets_ht600to800_CP5','MC',12.05),
    ('WJetsToLNu_HT-800To1200_TuneCP5_13TeV-madgraphMLM-pythia8',2017):('WJets_ht800to1200_CP5','MC',5.395),
    #'WJetsToLNu_HT-800To1200_TuneCP5_13TeV-madgraphMLM-pythia8':('WJets_ht800to1200_CP5','MC',5.501),
    ('WJetsToLNu_HT-1200To2500_TuneCP5_13TeV-madgraphMLM-pythia8',2017):('WJets_ht1200to2500_CP5','MC',1.08),
    #'WJetsToLNu_HT-1200To2500_TuneCP5_13TeV-madgraphMLM-pythia8':('WJets_ht1200to2500_CP5','MC',1.329),
    ('WJetsToLNu_HT-2500ToInf_TuneCP5_13TeV-madgraphMLM-pythia8',2017):('WJets_ht2500toinf_CP5','MC',0.008053),
    #'WJetsToLNu_HT-2500ToInf_TuneCP5_13TeV-madgraphMLM-pythia8':('WJets_ht2500toinf_CP5','MC',0.03216),
    #2016
    ('WJetsToLNu_HT-100To200_TuneCUETP8M1_13TeV-madgraphMLM-pythia8',2016):('WJets_ht100to200','MC',1346),
    ('WJetsToLNu_HT-200To400_TuneCUETP8M1_13TeV-madgraphMLM-pythia8',2016):('WJets_ht200to400','MC',359.1),
    ('WJetsToLNu_HT-400To600_TuneCUETP8M1_13TeV-madgraphMLM-pythia8',2016):('WJets_ht400to600','MC',48.96),
    ('WJetsToLNu_HT-600To800_TuneCUETP8M1_13TeV-madgraphMLM-pythia8',2016):('WJets_ht600to800','MC',12.05),
    ('WJetsToLNu_HT-800To1200_TuneCUETP8M1_13TeV-madgraphMLM-pythia8',2016):('WJets_ht800to1200','MC',5.487),
    ('WJetsToLNu_HT-1200To2500_TuneCUETP8M1_13TeV-madgraphMLM-pythia8',2016):('WJets_ht1200to2500','MC',1.329),
    ('WJetsToLNu_HT-2500ToInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8',2016):('WJets_ht2500toinf','MC',0.03215),
...
#     ('GJets_HT-200To400_TuneCUETP8M1_13TeV-madgraphMLM-pythia8',2016):('GJets_ht200to400','MC',2303),
