...
class AnalysisProcessor(processor.ProcessorABC):
    ...
    def __init__(self, year, xsec, corrections, ids, common):
        ...
        self._samples = {
            ...
            'tecr': ('WJets', 'DY', 'TT', 'ST', 'WW', 'WZ', 'ZZ', 'QCD', data_electron),
            'tmcr': ('WJets', 'DY', 'TT', 'ST', 'WW', 'WZ', 'ZZ', 'QCD', data_muon),
            'wecr': ('WJets', 'DY', 'TT', 'ST', 'WW', 'WZ', 'ZZ', 'QCD', data_electron),
            'wmcr': ('WJets', 'DY', 'TT', 'ST', 'WW', 'WZ', 'ZZ', 'QCD', data_muon),
        ...
        self._accumulator = processor.dict_accumulator({
            ...
            'jet_leading_pT': hist.Hist(
                ...
                hist.Cat('dataset', 'dataset'),
                hist.Cat('region', 'Region'),
                hist.Bin('jet_leading_pT', 'Leading $AK4 Jet p_{T}$ [GeV]',
            ...
            'jet_leading_eta': hist.Hist(
                'Events',
                hist.Cat('dataset', 'Dataset'),
                hist.Cat('region', 'Region'),
                hist.Bin('jet_leading_eta', 'AK4 Leading Jet Eta', 35, -3.5, 3.5)),
...
#                       (j_clean[j_clean['btagDeepB'] > btagWP_medium].counts == 1))
        regions = {
            'sre': {'isoneE', 'extrab_exactly_1', 'noHEMj', 'single_electron_triggers', 'met100',
                    'Delta_Phi_Met_LJ',
                    'DeltaR_LJ_Ele',
                    },
            'srm': {'isoneM', 'extrab_exactly_1', 'noHEMj', 'single_muon_triggers', 'met100',
                    'Delta_Phi_Met_LJ',
                    'DeltaR_LJ_Mu',
                    },
            'tecr': {'isoneE', 'extrab_atleast_2', 'noHEMj', 'single_electron_triggers', 'met100',
                     'Delta_Phi_Met_LJ',
                     'DeltaR_LJ_Ele',
                     },
            'tmcr': {'isoneM', 'extrab_atleast_2', 'noHEMj', 'single_muon_triggers', 'met100',
                     'Delta_Phi_Met_LJ',
                     'DeltaR_LJ_Mu',
                     },
            'wecr': {'isoneE', 'noextrab',  'noHEMj', 'single_electron_triggers', 'met100',
                     'Delta_Phi_Met_LJ',
                     'DeltaR_LJ_Ele',
                     },
            'wmcr': {'isoneM', 'noextrab', 'noHEMj', 'single_muon_triggers', 'met100',
                     'Delta_Phi_Met_LJ',
                     'DeltaR_LJ_Mu',
                     },
...
#         for sel in regions['wecr']:
#         test_e_sel = selection.all('exclude_low_WpT_JetHT')
#         print("events['exclude_low_WpT_JetHT']",len(events[test_e_sel]))
        isFilled = False
